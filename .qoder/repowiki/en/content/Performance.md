...
- [test_performance_regression.py](file://tests\performance\test_performance_regression.py)
- [test_line_numbers_performance.py](file://tests\performance\test_line_numbers_performance.py)
...
4. [Large Document Handling](#large-document-handling)
...
**Section sources**
- [performance.md](file://docs\performance.md#L1-L479)
...
**Section sources**
- [performance.md](file://docs\performance.md#L37-L88)
...
**Section sources**
- [performance.md](file://docs\performance.md#L90-L188)
...
**Section sources**
- [performance.md](file://docs\performance.md#L190-L273)
- [api.py](file://src\chunkana\api.py#L228-L271)
- [streaming_chunker.py](file://src\chunkana\streaming\streaming_chunker.py#L43-L79)
...
**Section sources**
- [performance.md](file://docs\performance.md#L275-L355)
...
**Section sources**
- [performance.md](file://docs\performance.md#L357-L450)
...
**Section sources**
- [performance.md](file://docs\performance.md#L452-L473)