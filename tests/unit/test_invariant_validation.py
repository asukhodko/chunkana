...
class TestInvariantValidation:
    ...
    def test_is_leaf_consistency_validation(self):
        ...
        # Verify auto-fix
        assert chunk1.metadata["is_leaf"] == False  # Should be fixed
        assert chunk2.metadata["is_leaf"] == True   # Should be fixed
    ...
    def test_validation_disabled(self):
        ...
        assert builder.validate_invariants == False
        assert builder.strict_mode == True
...
"""
        ...
        for chunk in result.chunks:
            ...
            assert is_leaf == expected_is_leaf, f"Chunk {chunk.metadata.get('chunk_id')} has inconsistent is_leaf"
...
"""
        ...
        assert builder.validate_chains == True  # Should fall back to old validation
