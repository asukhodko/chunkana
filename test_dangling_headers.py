...
from chunkana.header_processor import HeaderProcessor, DanglingHeaderDetector
...
def test_header_moving():
    ...
    if len(fixed_chunks) == 2:
        ...
        if "#### Details" in fixed_chunks[1].content and "#### Details" not in fixed_chunks[0].content:
